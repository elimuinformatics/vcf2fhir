...
class Converter(object):
    def __init__(self, vcf_filename=None, ref_build=None, patient_id = None, no_call_filename = None, conv_region_filename=None):
    ...
    def convert(self, output_filename='fhir.json'):
        try:
            _getFhirJSON(self._vcf_reader, self.ref_build, self.patient_id, output_filename, self.no_call_filename, self.conv_region_filename)
        except Exception:
            raise Exception
            return False
        return True
